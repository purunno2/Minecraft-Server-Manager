...
## 日本語化（まだ完全ではない）
[Benjerman](https://github.com/Benjerman)氏が開発したMinecraft Bedrock Edition（以下、統合版）の公式サーバーソフトをGUIで操作できる機能を実装したアプリケーション、[Minecraft Bedrock Server Manager]https://github.com/Benjerman/Minecraft-Server-Manager) を日本語化しました。ただし、まだ完全ではありません。
